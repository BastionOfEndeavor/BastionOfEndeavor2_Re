...
/datum/controller/subsystem/ticker/proc/pregame_welcome()
	/* Bastion of Endeavor Translation
	to_world(span_boldannounce notice("<em>Welcome to the pregame lobby!</em>"))
	to_world(span_boldannounce notice("Please set up your character and select ready. The round will start in [pregame_timeleft] seconds."))
	*/
		...
		for(var/obj/effect/landmark/start/S in landmarks_list)
			...
			*/
			...
			// End of Bastion of Endeavor Translation
				qdel(S)
		/* Bastion of Endeavor Translation
		to_world(span_boldannounce notice("<em>Enjoy the game!</em>"))
		*/
